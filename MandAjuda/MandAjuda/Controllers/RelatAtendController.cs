...
namespace MandAjuda.Controllers
{
    public class RelatAtendController : Controller
    {
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.Profissional = Convert.ToInt32(Request.QueryString["idp"]);
        ...
        public ActionResult Create([Bind(Include = "RelatAtendId,ProfissionalId,ClienteId,ChamadoId,DataHoraInicio,DataHoraTermino,Descricao")] RelatAtend relatAtend)
        {
